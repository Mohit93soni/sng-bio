...
export default function Product() {
  const structuredData = {
    ...
    description:
      "Revolutionary hybrid bioprinting and electrospinning platform for creating complex tissue structures and neural engineering applications.",
    brand: {
      "@type": "Brand",
      name: "SND Regenics",
    },
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl md:text-5xl font-bold text-foreground leading-tight">
                  ...
                  <span className="text-primary">Regenerative Innovation</span>{" "}
                  & Trusted{" "}
              ...
              <div className="lg:col-span-1">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex items-start space-x-3 py-3 border-b border-border last:border-b-0"
                    >
                  ...
                  <Card className="border border-border bg-card">
                    ...
                    <CardContent>
                      <p className="text-sm text-muted-foreground mb-4">
                        ...
                        electrospinning technology. Enables precise control over
                        tissue architecture with unprecedented accuracy and
                        reliability.
                      </p>
                  ...
                  <Card className="border border-border bg-card">
                    ...
                    <CardContent>
                      <p className="text-sm text-muted-foreground mb-4">
                        ...
                        applications. Promotes cell growth, neural network
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    porttitor auque ut semper donec amet rhoncus est. Et nunc
                    scelerisque in nunc. At amet blandit dolor aliquetd varius
                    turpis mattis elit mauris.
                  </p>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Comprehensive solutions for advanced biomedical research and
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="group hover:shadow-lg transition-all duration-300">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Advanced electrospinning capabilities for creating
                    nanofibrous scaffolds with precise control over fiber
              ...
              <Card className="group hover:shadow-lg transition-all duration-300">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground mb-4">
                    State-of-the-art 3D bioprinting technology for creating
                    complex tissue structures with cellular precision.
                  </p>
                  <Link
                    to="/contact"
                    className="inline-flex items-center text-primary hover:text-primary/80 font-medium"
              ...
              <Card className="group hover:shadow-lg transition-all duration-300">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-3">
                    Neural Tissue Solutions
                  </h3>
                  <p className="text-muted-foreground mb-4">
                    Specialized solutions for neural tissue engineering,
                    including biocompatible materials and culture systems.
                  </p>
                  <Link
                    to="/contact"
                    className="inline-flex items-center text-primary hover:text-primary/80 font-medium"
