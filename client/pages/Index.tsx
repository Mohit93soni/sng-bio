              ...
              <div className="relative bg-gradient-to-br from-primary/10 to-accent/30 rounded-2xl p-8 backdrop-blur-sm">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-4">
                    ...
                    <h3 className="font-semibold text-foreground">3D Bioprinting</h3>
                    <p className="text-sm text-muted-foreground">Advanced tissue fabrication technology</p>
                  </div>
                  <div className="space-y-4">
                    <div className="w-12 h-12 bg-primary/20 rounded-lg flex items-center justify-center">
                      <Brain className="h-6 w-6 text-primary" />
                    </div>
                    <h3 className="font-semibold text-foreground">Neural Tissue</h3>
                    <p className="text-sm text-muted-foreground">Specialized neural tissue culture</p>
                  </div>
                  <div className="space-y-4">
                    <div className="w-12 h-12 bg-primary/20 rounded-lg flex items-center justify-center">
                    ...
                    <p className="text-sm text-muted-foreground">Cutting-edge biomedical research</p>
                  </div>
                  <div className="space-y-4">
                    <div className="w-12 h-12 bg-primary/20 rounded-lg flex items-center justify-center">
                    ...
                    <p className="text-sm text-muted-foreground">Personalized medicine solutions</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Advancing the frontiers of biomedical science through interdisciplinary research 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-card/50 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-3">Neuroscience</h3>
                <p className="text-muted-foreground mb-4">
                  Advanced neural tissue research and brain organoid development for neurological disorder studies.
                </p>
                <Link to="/research" className="inline-flex items-center text-primary hover:text-primary/80 font-medium">
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-card/50 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-3">3D-Bioprinting & Scaffolding</h3>
                <p className="text-muted-foreground mb-4">
                  Revolutionary hybrid fabrication combining bioprinting and electrospinning technologies.
                </p>
                <Link to="/research" className="inline-flex items-center text-primary hover:text-primary/80 font-medium">
                  Learn more <ChevronRight className="ml-1 h-4 w-4" />
                </Link>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-card/50 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-3">3D-Neural Tissue Culture</h3>
                <p className="text-muted-foreground mb-4">
                  Specialized culture systems for growing complex neural tissues in controlled environments.
                </p>
                <Link to="/research" className="inline-flex items-center text-primary hover:text-primary/80 font-medium">
                  Learn more <ChevronRight className="ml-1 h-4 w-4" />
                </Link>
              ...
              <CardContent className="p-8">
                <div className="flex items-start space-x-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-foreground mb-3">Bioinformatics & Machine Learning</h3>
                    <p className="text-muted-foreground mb-4 max-w-4xl">
                      Leveraging artificial intelligence and computational biology to accelerate research discoveries 
                      and optimize biomedical processes. Our ongoing research integrates machine learning algorithms 
                      with bioinformatics to predict tissue behavior and optimize treatment protocols.
                    </p>
                    <Link to="/research" className="inline-flex items-center text-primary hover:text-primary/80 font-medium">
                      Explore our AI research <ChevronRight className="ml-1 h-4 w-4" />
                    </Link>
                  </div>
                </div>
              </CardContent>
              ...
              <div className="space-y-6">
                <Card className="border-0 bg-gradient-to-br from-primary/5 to-accent/10">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Revolutionary combination of 3D bioprinting and electrospinning in a single platform, 
                      enabling unprecedented control over tissue architecture.
                    </p>
                ...
                <Card className="border-0 bg-gradient-to-br from-accent/10 to-primary/5">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Specialized biomaterials designed for neural tissue applications, promoting cell growth 
              ...
              <div className="space-y-6">
                <Card className="border-0 bg-gradient-to-br from-accent/10 to-primary/5">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Tailored scaffold design and fabrication services for specific research applications 
                ...
                <Card className="border-0 bg-gradient-to-br from-primary/5 to-accent/10">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Educational programs and workshops to train researchers and clinicians in advanced 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              "At SND Regenics, we've engineered a cutting-edge hybrid machine that combines 3D bioprinting 
              and electrospinning. This innovation is set to revolutionize drug testing, organogenesis, and 
              regenerative medicine. Our technology offers customized solutions that will transform the landscape 
              of biomedical research, laying the foundation for the future of personalized, patient-centric medicine."
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/product" className="text-muted-foreground hover:text-primary">Products</Link></li>
                <li><Link to="/service" className="text-muted-foreground hover:text-primary">Services</Link></li>
                <li><Link to="/research" className="text-muted-foreground hover:text-primary">R&D</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/contact" className="text-muted-foreground hover:text-primary">Get in Touch</Link></li>
                <li><Link to="/news" className="text-muted-foreground hover:text-primary">News & Events</Link></li>
