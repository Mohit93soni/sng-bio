        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Ready to revolutionize biomedical research together? Get in touch
              with our team to discuss partnerships, collaborations, or learn
              more about our cutting-edge solutions.
            </p>
          </div>
        </div>
      </section>
